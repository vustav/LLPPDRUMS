...
public class StepEventsManager {
    ...
    public StepEventsManager(LLPPDRUMS llppdrums, DrumSequence drumSequence, DrumTrack drumTrack, SoundSourceManager soundSourceManager, Step step, int nOfSubs){
    ...
    private void addSub(boolean guaranteeOn){
        subs.add(new Sub(llppdrums, drumSequence, drumTrack, soundSourceManager, this, step, guaranteeOn));
    }
