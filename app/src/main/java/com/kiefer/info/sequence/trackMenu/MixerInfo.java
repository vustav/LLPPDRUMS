...
public class MixerInfo implements Info {
    private final LLPPDRUMS llppdrums;
    public static String key = "mixerInfo";

    public MixerInfo(LLPPDRUMS llppdrums) {
        this.llppdrums = llppdrums;
    }

    @Override
    public String getName() {
        return llppdrums.getResources().getString(R.string.mixerName);
    }
    ...
    public ViewGroup getLayout() {
        ...
        nodeTV1.setText(R.string.mixerIntro);
