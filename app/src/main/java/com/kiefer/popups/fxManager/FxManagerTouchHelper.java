...
public class FxManagerTouchHelper extends ItemTouchHelper.SimpleCallback {

    private FxManagerAdapter adapter;
    ...
    public FxManagerTouchHelper(FxManagerAdapter adapter){
