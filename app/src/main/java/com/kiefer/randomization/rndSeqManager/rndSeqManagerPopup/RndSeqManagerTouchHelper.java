...
public class RndSeqManagerTouchHelper extends ItemTouchHelper.SimpleCallback {

    private RndSeqManagerAdapter adapter;
    ...
    public RndSeqManagerTouchHelper(RndSeqManagerAdapter adapter){
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if(dragStart != dragEnd && dragDone){
            adapter.moveTrack(dragStart, dragEnd);
            dragDone = false;
        }
