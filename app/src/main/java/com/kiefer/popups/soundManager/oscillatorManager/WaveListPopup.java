...
public class WaveListPopup extends Popup {

    public WaveListPopup(LLPPDRUMS llppdrums, final OscillatorManager oscillatorManager, final OscillatorView oscillatorViewPopup, int oscNo, final CSpinnerButton btn){
        super(llppdrums);
