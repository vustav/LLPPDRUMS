...
public class AutoRndMinPopup extends Popup {
    private CSeekBar seekBar;
    private View.OnTouchListener onTouchListener;

    public AutoRndMinPopup(final LLPPDRUMS llppdrums, final SequenceModule sequenceModule, final AutoRandomModule autoRandomModule, final ImageView iv, final Step step, int sub) {
        this(llppdrums, sequenceModule, autoRandomModule, iv, step, sub, null, null);
    }

    public AutoRndMinPopup(final LLPPDRUMS llppdrums, final SequenceModule sequenceModule, final AutoRandomModule autoRandomModule, final ImageView iv, final Step step, int sub, AutoRndMinSubsPopup subsPopup, FrameLayout subLayout){
        super(llppdrums);
        ...
        seekBar.setProgress(sequenceModule.getAutoRndMin(step, sub));
